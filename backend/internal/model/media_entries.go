...
type MediaEntry struct {
	...
	ExternalSiteStatus  map[string]MediaSiteSyncStatus `gorm:"column:external_site_status;serializer:json" json:"externalSiteStatus"`
...
type MediaSiteSyncStatus struct {
